...
final _fromJsons = {
  ...
  Exif: _one<Exif>(Exif.fromJson),
  Location: _one<Location>(Location.fromJson),
  ...
  UpdatePhoto: _one<UpdatePhoto>(UpdatePhoto.fromJson),
  UpdateUser: _one<UpdateUser>(UpdateUser.fromJson),
  ...
  List<Exif>: _list<Exif>(Exif.fromJson),
  List<Location>: _list<Location>(Location.fromJson),
  ...
  List<UpdatePhoto>: _list<UpdatePhoto>(UpdatePhoto.fromJson),
  List<UpdateUser>: _list<UpdateUser>(UpdateUser.fromJson),
